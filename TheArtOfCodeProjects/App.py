...
def RunApp():
    ...
    my_engine.designer.canvas_ref.vao_manager.shader_programs.shader_scripts_dir = os.path.join(file_path, projects_paths[3])
    
    my_script = BasicShaderScript(canvasRef=my_engine.designer.canvas_ref, 
                                  shaderProgramName="TheArtOfCode",
                                  vertShaderName="norm", fragShaderName=projects_scripts[3])
