...
/**
    ...
    Use of Cellular Noise for Art

    In this case, it draws the cellular pattern of the crossection of plant tissue.

    URL: https://thebookofshaders.com/edit.php#12/tissue.frag
*/
