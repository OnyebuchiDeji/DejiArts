...
/**
*   This version increases the blur range
*/
...
*/
vec3 directionalBlur(vec2 uv, vec2 direction, float mag) {
    vec3 color = vec3(0.0);
    float totalWeight = 0.0;

    for (float i = -mag; i <= mag; i++) {
...
void main() {
    ...
    vec3 blurCol = directionalBlur(uv, dir, 5.0);
